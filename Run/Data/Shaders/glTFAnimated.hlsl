...
cbuffer NodeTransformConstants : register(b4)
{
...
v2p_t VertexMain(vs_input_t input)
{
	...
	float4 animatedModelSpacePosition = mul(NodeTransform, modelSpacePosition);

	float4 worldSpacePosition = mul(ModelToWorldTransform, animatedModelSpacePosition);
